document.addEventListener("DOMContentLoaded", function(){
    ...
    async function formSend(form_event){
        ...
        if(!error){
            ...
            let x = formReq[0].value;
            let y = formReq[1].value;
            let R = formReq[2].value;
    ...
    async function addResult(x,y,R,hit){
        ...
        if(lastResultIndex < MAX_RESULTS_IN_TABLE){
            ...
            if(lastResultIndex == resultArr.length - 1){
                ...
                results.appendChild(createResultRow(firstRes.x,
                                                    firstRes.y,
                                                    firstRes.R,
                                                    firstRes.hit
                                                   ))
                ...
                results.appendChild(createResultRow(secondRes.x,
                                                   secondRes.y,
                                                   secondRes.R,
                                                   secondRes.hit
                                                   ));
    ...
    async function updateDotsInChart(){
        ...
        let style = "margin-left: " + String(xPercentage) + "%;" +
